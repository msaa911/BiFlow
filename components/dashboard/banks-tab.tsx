                            ...
                            <table className="w-full text-left border-collapse">
                                <thead>
                                    <tr className="text-[10px] font-bold text-gray-500 border-b border-gray-800">
                                        <th className="pl-4 pr-1 py-4 font-black sticky top-0 z-20 bg-gray-900 text-left">Estado</th>
                                        ...
                                        <th className="pr-4 pl-1 py-4 text-right font-black sticky top-0 z-20 bg-gray-900">Monto (ARS)</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-800/50">
                                    {filteredTx.map((t: any) => (
                                        <tr key={t.id} className="group hover:bg-emerald-500/[0.02] transition-colors">
                                            ...
                                            <td className="px-1 py-2.5 font-mono text-[10px] text-gray-400">{t.metadata?.referencia || '-'}</td>
                                            <td className="px-1 py-2.5">
                                            ...
                                            <td className={`pr-4 pl-1 py-2.5 text-right font-black text-xs ${t.monto < 0 ? 'text-red-400' : 'text-emerald-400'} whitespace-nowrap`}>
                                                <div className="flex items-center justify-end gap-3">
                                                    ...
                                                    {t.estado === 'conciliado' && (
                                                        <Button
                                                            variant="ghost"
                                                            size="icon"
                                                            className="h-6 w-6 text-gray-500 hover:text-amber-500"
