                                    ...
                                    <td className="px-4 py-3 text-right flex items-center justify-end gap-2">
                                        {item.estado === 'requiere_ajuste' && (
                                            <button
                                                ...
                                                className="text-xs px-3 py-1 rounded-md font-bold transition-all flex items-center gap-1 shadow-lg scale-95 hover:scale-100 bg-orange-600 hover:bg-orange-500 text-white shadow-orange-500/20"
