...
DROP TABLE IF EXISTS view_metrics_hallazgos CASCADE;
DROP TABLE IF EXISTS csv_mapeos CASCADE;
DROP TABLE IF EXISTS human_reviews CASCADE;
DROP TABLE IF EXISTS processing_logs CASCADE;
DROP TABLE IF EXISTS notificaciones CASCADE;
DROP TABLE IF EXISTS cuits_conocidos CASCADE;
DROP TABLE IF EXISTS hallazgos CASCADE;
DROP TABLE IF EXISTS transacciones CASCADE;
DROP TABLE IF EXISTS organization_members CASCADE;
DROP TABLE IF EXISTS organizations CASCADE;

-- Clear functions to avoid conflicts
