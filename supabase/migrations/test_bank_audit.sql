...
-- Test Data for Bank Fee Audit
-- Organization ID for reference: Miguel (e610d869-d9d1-447a-8531-180b55502e1c)

-- 1. Asegurar que haya un convenio bancario (1.2% de comision por cheque)
...
-- 2. Insertar transacciones que violen el convenio
...
-- Un mantenimiento de $7,500 cuando el pactado es $5,000
